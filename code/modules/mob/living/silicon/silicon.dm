...
/mob/living/silicon/verb/pose()
	...
	pose =  (tgui_input_text(usr, "This is [src]. It is...", "Pose", null))
...
/mob/living/silicon/verb/set_flavor()
	...
	var/new_flavortext = (tgui_input_text(usr, "Please enter your new flavour text.", "Flavour text", flavor_text, multiline = TRUE))
	if(new_flavortext)
