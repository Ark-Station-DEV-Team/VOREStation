	...
	switch(action)
		...
		if("ears_color")
			if(can_change(APPEARANCE_HAIR_COLOR))
				...
				if(new_hair && can_still_topic(usr, state))
					target.r_ears = hex2num(copytext_char(new_hair, 2, 4))
					target.g_ears = hex2num(copytext_char(new_hair, 4, 6))
					target.b_ears = hex2num(copytext_char(new_hair, 6, 8))
					update_dna()
					owner.update_hair()
					changed_hook(APPEARANCECHANGER_CHANGED_HAIRCOLOR)
					return 1
		if("ears2_color")
			if(can_change(APPEARANCE_HAIR_COLOR))
				...
				if(new_hair && can_still_topic(usr, state))
					target.r_ears2 = hex2num(copytext_char(new_hair, 2, 4))
					target.g_ears2 = hex2num(copytext_char(new_hair, 4, 6))
					target.b_ears2 = hex2num(copytext_char(new_hair, 6, 8))
					update_dna()
					owner.update_hair()
					changed_hook(APPEARANCECHANGER_CHANGED_HAIRCOLOR)
					return 1
		...
		if("tail_color")
			if(can_change(APPEARANCE_HAIR_COLOR))
				...
				if(new_hair && can_still_topic(usr, state))
					target.r_tail = hex2num(copytext_char(new_hair, 2, 4))
					target.g_tail = hex2num(copytext_char(new_hair, 4, 6))
					target.b_tail = hex2num(copytext_char(new_hair, 6, 8))
					update_dna()
					owner.update_tail_showing()
					changed_hook(APPEARANCECHANGER_CHANGED_HAIRCOLOR)
					return 1
		if("tail2_color")
			if(can_change(APPEARANCE_HAIR_COLOR))
				...
				if(new_hair && can_still_topic(usr, state))
					target.r_tail2 = hex2num(copytext_char(new_hair, 2, 4))
					target.g_tail2 = hex2num(copytext_char(new_hair, 4, 6))
					target.b_tail2 = hex2num(copytext_char(new_hair, 6, 8))
					update_dna()
					owner.update_tail_showing()
					changed_hook(APPEARANCECHANGER_CHANGED_HAIRCOLOR)
					return 1
		...
		if("wing_color")
			if(can_change(APPEARANCE_HAIR_COLOR))
				...
				if(new_hair && can_still_topic(usr, state))
					target.r_wing = hex2num(copytext_char(new_hair, 2, 4))
					target.g_wing = hex2num(copytext_char(new_hair, 4, 6))
					target.b_wing = hex2num(copytext_char(new_hair, 6, 8))
					update_dna()
					owner.update_wing_showing()
					changed_hook(APPEARANCECHANGER_CHANGED_HAIRCOLOR)
					return 1
		if("wing2_color")
			if(can_change(APPEARANCE_HAIR_COLOR))
				...
				if(new_hair && can_still_topic(usr, state))
					target.r_wing2 = hex2num(copytext_char(new_hair, 2, 4))
					target.g_wing2 = hex2num(copytext_char(new_hair, 4, 6))
					target.b_wing2 = hex2num(copytext_char(new_hair, 6, 8))
					update_dna()
					owner.update_wing_showing()
					changed_hook(APPEARANCECHANGER_CHANGED_HAIRCOLOR)
					return 1
